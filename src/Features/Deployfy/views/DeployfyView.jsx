...
import './DeployfyView.css'; // Import the CSS file for the shimmer effect
...
import NavbarComponant from '../componants/NavbarComponant'; // Import the NavbarComponant
import TestComponent from '../componants/testComponent'; // Import the TestComponent
  ...
  return (
    <div className="min-h-screen relative shimmer">
      ...
      <main className="pt-20 snap-container"> 
        <NavbarComponant showMenu={showMenu} toggleMenu={toggleMenu} scrollToSection={scrollToSection} /> {/* Use NavbarComponant */}
